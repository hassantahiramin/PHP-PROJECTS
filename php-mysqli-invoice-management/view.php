...
<title>Adminbook&reg; | View Invoice</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">Sales Invoice <small>(Read)</small></h3>
			<div class="page-bar">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box blue-chambray"><!-- form_invoice -->
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-share-square-o"></i> Process Sales Invoice # <?php $view->selected_invoice_number(); ?>
							</div>
						</div>
						<div class="portlet-body">
							<div class="portlet-body form">
                <a href="index.php" class="btn green button-submit" ><i class="fa fa-reply"></i> Back Sales Invoice</a>
								<form action="index.php" class="form-horizontal" name="invoice_form" id="invoice_form" method="post" enctype="multipart/form-data" autocomplete="off">
									<input type="hidden" name="invoice_id" value="<?php $view->select_invoice_id(); ?>">
									<div class="form-wizard">
										<div class="form-body">
													<h3 class="inline font-green">Details For Sales Invoice# <?php $view->selected_invoice_num(); ?></h3>
													<h4 class="form-section">Customer Details:</h4>
													<div class="form-group">
														<label class="control-label col-md-3">Customer Service Identification #</label>
														<div>
															<?php $view->selected_customer_csid(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Company Name:</label>
														<div>
															<?php $view->selected_company_name(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Customer Title:</label>
														<div>
															<?php $view->selected_customer_title(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Customer Name:</label>
														<div>
															<?php $view->selected_customer_name(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Customer Job Title:</label>
														<div>
															<?php $view->selected_customer_job_title(); ?>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-9">
															<?php $view->selected_invoice_type_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Invoice Status:</label>
														<div class="col-md-9">
															<?php $view->selected_invoice_status_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Invoice Date:</label>
														<div class="col-md-9">
															<?php $view->selected_invoice_date_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Due Date:</label>
														<div class="col-md-9">
															<?php $view->selected_invoice_due_date_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Invoice Prepared By:</label>
														<div class="col-md-9">
															<?php $view->selected_prepared_by_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Purchase Order Number:</label>
														<div class="col-md-9">
															<?php $view->selected_purchase_order_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Country of Origin:</label>
														<div class="col-md-9">
															<?php $view->selected_country_origin_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Port of Shipment:</label>
														<div class="col-md-9">
															<?php $view->selected_shipment_port_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Port of Destination:</label>
														<div class="col-md-9">
															<?php $view->selected_destination_port_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Terms of Sale / Incoterms &reg; 2010:</label>
														<div class="col-md-9">
															<?php $view->selected_incoterms_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Terms of Payment:</label>
														<div class="col-md-9">
															<?php $view->selected_payment_terms_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Mode of Transport:</label>
														<div class="col-md-9">
															<?php $view->selected_transport_mode_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Exporting Carrier:</label>
														<div class="col-md-9">
															<?php $view->selected_exporting_carier_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Freight:</label>
														<div class="col-md-9">
															<?php $view->selected_freight_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Shipment Date:</label>
														<div class="col-md-9">
															<?php $view->selected_shipment_date_review(); ?>
														</div>
													</div>
													<h4 class="form-section">Invoice Details:</h4>
													<div class="form-group">
														<label class="control-label col-md-3">Subtotal <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_sub_total_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">VAT / TAX <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_tax_total_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Discount <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_discount_total_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Insurance <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_insurance_total_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Shipping &amp; Handling <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_shipping_total_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Total <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_total_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Amount Paid <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_paid_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Total Amount Due <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_due_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Total Amount Words <?php $view->selected_currency(); ?>:</label>
														<div class="col-md-9">
															<?php $view->saved_amount_due_review(); ?>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Comments or Special Instructions:</label>
														<div class="col-md-9">
															<?php $view->saved_notes_review(); ?>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
                                                    <button type="submit" name="Submit" class="btn grey-steel button-submit" value="print" id="SubPrint" disabled><i class="fa fa-print"></i> Print Sales Invoice</button>
                                                    <button type="submit" name="Submit" class="btn grey-gallery button-submit" value="download" id="SubDownload" disabled><i class="fa fa-cloud-download"></i> Download Sales Invoice</button>
													<button type="submit" name="Submit" class="btn blue-chambray button-submit" value="email" id="SubEmail" disabled><i class="fa fa-envelope"></i> E-mail Sales Invoice</button>
												</div>
											</div>
										</div>
									</div>
...
$('#invoice_form').attr('target', '_blank');
});
$('#SubDownload').on("click",function() {
$('#invoice_form').attr('target', '_self');
});
