...
$(window).load(function() {
    ...
    MESSAGES.push({
        delay: 1800,
        text: 'It looks like smething went wrong on page you are accessing'
    });
    MESSAGES.push({
        delay: 3200,
        text: 'If you require assistance please contact the support team who will be happy to help.'
    });
    MESSAGES.push({
        delay: 4800,
