<?php
  ...
  if($validation->passed()){
    ...
    $subject    = "New Website Contact Message From $customer_name.";
                     ...
                     <table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'>
                       <tr>
                         <td style='padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;'>
                           <h1 style='margin: 0 0 10px 0; font-family: sans-serif; font-size: 24px; line-height: 27px; color: #333333; font-weight: normal;'>Contact Message Details.</h1>
                    ...
                    <table role='presentation' cellspacing='0' cellpadding='0' border='0' align='center' width='100%' style='max-width: 680px;'>
                      <tr>
                        <td style='padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; line-height:18px; text-align: center; color: #888888;' class='x-gmail-data-detectors'>
                          ...
                          <br><br>
                          This Contact Email Was Generated With Business Management Systems Exporter's Edition.
                        </td>
                      </tr>
                    </table>
                    <!-- Email Footer : END -->
      ...
      try
        {
         ...
         if($mail->Send())
         {
           ...
           <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Your Contact Message has been Successfully Submitted.</b></div>";
         }
        }
